...
class TestNodeParentSetter(unittest.TestCase):
    ...
    def test_should_set_a_nodes_parent_to_passed_node(self):
...
class TreeNodeIsBreadthFirstSearchable(unittest.TestCase):
    ...
    def test_should_return_itself_if_it_contains_the_value(self):
        self.assertEqual(self.nodes[0].breadth_first_search("a"), self.nodes[0])

    def test_should_find_descendant(self):
        self.assertEqual(self.nodes[0].breadth_first_search("g"), self.nodes[-1])

    def test_should_return_Nonde_when_value_not_found(self):
        self.assertIsNone(self.nodes[0].breadth_first_search("x"))
